# ============================================================
# WHALE HUNTER v27.0 - SMART MONEY (FUNCIONAL)
# ============================================================
# Como os comandos 'track' não funcionam,
# esta versão usa 'market trending' + 'token info'
# para identificar tokens com Smart Money.
# ============================================================
...
MIN_VOLUME = 10000
MIN_HOLDERS = 30
MAX_TOP10_HOLDERS = 50
MAX_DEV_HOLD = 20
MAX_SELL_TAX = 25
MIN_PRICE_CHANGE = 1.0
MIN_SMART_MONEY = 1     # ACEITA 1 SMART MONEY
MIN_SCORE = 35
...
if __name__ == "__main__":
    print("=== INICIANDO WHALE HUNTER v27.0 (SMART MONEY) ===")
    
    send("🟢 *WHALE HUNTER v27.0 ONLINE*\n\n"
         "🧠 *SMART MONEY MONITOR*\n"
